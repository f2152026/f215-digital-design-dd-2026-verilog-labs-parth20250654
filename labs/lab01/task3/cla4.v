...
module cla4(
  ...
  // c1 = or(#2) (g0, and(#2)(p0,cin));
  // c2 = or(#2) (g1, and(#2)(p1, g0), and(#2)(p1,p0,cin));
  // c3 = or(#2) (g2, and(#2)(p2,g1), and(#2)(p2, p1, g0), and(#2)(p2, p1, p0, cin));
  // cout = or(#2) (g3, and(#2)(p3,g2), and(#2)(p3,p2,g1), and(#2)(p3,p2,p1,g0), and(#2)(p3,p2,p1,p0,cin));
...
//   // Carry Out: cout = g3 | (p3 & g2) | (p3 & p2 & g1) | (p3 & p2 & p1 & g0) | (p3 & p2 & p1 & p0 & cin)
